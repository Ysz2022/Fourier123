...
from FSDLoss import FSDLoss
fsd = FSDLoss(loss_weight=1.0, alpha=1.0)
...
class StableDiffusion(nn.Module):
    ...
    @torch.no_grad()
    def refine(self, pred_rgb, step_ratio,
        ...
        #     image.save('visual/sd/'+str(step_ratio)+str(i)+'.png')
    ...
    def train_step(
        ...
        # Calculate fourier
        loss = 20000 * fsd(latents, target)/ latents.shape[0]
